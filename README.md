I used the load_cancer_data set from sk.learn and used it to create predictive models that displayed the accuracy of certain test that were ran to gather this data. 
